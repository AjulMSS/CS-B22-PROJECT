    ...
    with mp_pose.Pose(min_detection_confidence=0.5,
        ...
        while cap.isOpened():
            ...
            try:
                ...
                shoulder = [landmarks[ls].x, landmarks[ls].y]
                elbow = [landmarks[le].x, landmarks[le].y]
                wrist = [landmarks[lw].x, landmarks[lw].y]
